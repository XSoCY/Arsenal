#ifndef MONITORRECVWORKER_H
#define MONITORRECVWORKER_H
...
class MonitorUi;
class WaitObj;
class MonitorRecvWorker : public QObject
{
    Q_OBJECT
public:
    explicit MonitorRecvWorker(MonitorUi *monitorUi,
